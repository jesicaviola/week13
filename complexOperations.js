var basicOperations = require('./basicOperations');

var isString = basicOperations.isString;
var isArray = basicOperations.isArray;
var isNumber = basicOperations.isNumber;
var validateEmail = basicOperations.validateEmail;
var isSupportedFigure = basicOperations.isSupportedFigure;
var arrayElementsAreObjectWithKey = basicOperations.arrayElementsAreObjectWithKey;
var sum = basicOperations.sum;
var multip = basicOperations.multip;
var division = basicOperations.division;
var exponent = basicOperations.exponent;
var arrayIntersection = basicOperations.arrayIntersection;
var sortArrayByKey = basicOperations.sortArrayByKey;
var getOddNumbersFromArray = basicOperations.getOddNumbersFromArray;
var getEvenNumbersFromArray = basicOperations.getEvenNumbersFromArray;
...
*/
const calculateArea = (figure, number1, number2 = 0) => {
 ...
 * @returns {string}
*/
const sumGratherThan = (number1, number2, number3) => {
